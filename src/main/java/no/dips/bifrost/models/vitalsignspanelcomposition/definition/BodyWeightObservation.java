...
@Generated(
    ...
    date = "2020-12-27T09:23:36.474782+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.0.0"
)
public class BodyWeightObservation implements EntryEntity {
  /**
   * Path: Vital Signs Panel/Body weight/origin
   */
  @Path("/data[at0002]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: Vital Signs Panel/Body weight/Device
  ...
  /**
   * Path: Vital Signs Panel/Body weight/Extension
  ...
  /**
   * Path: Vital Signs Panel/Body weight/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Vital Signs Panel/Body weight/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Vital Signs Panel/Body weight/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: Vital Signs Panel/Body weight/Any event
