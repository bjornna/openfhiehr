...
@Generated(
    ...
    date = "2020-12-27T09:23:36.145772800+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.0.0"
)
public class RespirationObservation implements EntryEntity {
  /**
   * Path: Vital Signs Panel/Respiration/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: Vital Signs Panel/Respiration/Extension
  ...
  /**
   * Path: Vital Signs Panel/Respiration/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Vital Signs Panel/Respiration/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Vital Signs Panel/Respiration/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: Vital Signs Panel/Respiration/Any event
