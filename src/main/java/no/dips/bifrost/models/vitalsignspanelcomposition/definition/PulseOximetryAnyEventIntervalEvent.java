...
@Generated(
    ...
    date = "2020-12-27T09:23:36.368778100+01:00",
...
public class PulseOximetryAnyEventIntervalEvent implements IntervalEventEntity, PulseOximetryAnyEventChoice {
  ...
  /**
   * Path: Vital Signs Panel/Pulse oximetry/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Vital Signs Panel/Pulse oximetry/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Vital Signs Panel/Pulse oximetry/Any event/sample_count
   */
  @Path("/sample_count")
