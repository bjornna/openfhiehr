...
@Generated(
    ...
    date = "2020-12-27T09:23:36.266777900+01:00",
...
public class PulseHeartBeatAnyEventIntervalEvent implements IntervalEventEntity, PulseHeartBeatAnyEventChoice {
  ...
  /**
   * Path: Vital Signs Panel/Pulse/Heart beat/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Vital Signs Panel/Pulse/Heart beat/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Vital Signs Panel/Pulse/Heart beat/Any event/sample_count
   */
  @Path("/sample_count")
