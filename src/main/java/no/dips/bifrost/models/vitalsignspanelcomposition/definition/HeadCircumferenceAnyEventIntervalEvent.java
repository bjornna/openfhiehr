...
@Generated(
    ...
    date = "2020-12-27T09:23:36.507780200+01:00",
...
public class HeadCircumferenceAnyEventIntervalEvent implements IntervalEventEntity, HeadCircumferenceAnyEventChoice {
  ...
  /**
   * Path: Vital Signs Panel/Head circumference/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Vital Signs Panel/Head circumference/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Vital Signs Panel/Head circumference/Any event/sample_count
   */
  @Path("/sample_count")
